...
_Last updated: 2026-09-01 — phase 12 sub-phase 12.1 closed; 12.2 open._
...
| 12 | [phase_13.md](phase_13.md) | Query Inspector and plan history | `agent-2:sonnet` | 12.3 | IN_PROGRESS — 12.2 open |
...
| 12.2 | The statement list | `agent-2:sonnet` | OPEN |
...
| `UI-QRY-010 … UI-QRY-045` | Vitest, unit + route | 12.2 – 12.6 | TODO |

...
_Last updated: 2026-09-01 — phase 13 sub-phase 13.5 closed; 13.6 open._
...
| **ID** | 13.6 |
| **Status** | `OPEN` |
| **Intent** | Update README.md for Locks and Activity |
| **Next action:** | Complete sub-phase **13.6** in [phase_14.md](phase_14.md): document sampling limits, no-sample semantics, signal gates, and command audit |
...
| 13 | [phase_14.md](phase_14.md) | Locks and Activity | `agent-2:sonnet` | 13.6 | IN_PROGRESS — 13.1–13.5 done, 13.6 open |
...
| 13.6 | Update README.md | `agent-3:haiku` | OPEN |

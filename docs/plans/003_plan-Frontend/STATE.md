...
_Last updated: 2026-09-01 — phase 16 sub-phase 16.4 open (claimed)._
...
| **ID** | 16.4 |
| **Status** | `OPEN` |
| **Intent** | Complete degraded and error paths (rule T-4) |
| **Next action:** | Complete sub-phase **16.4** in [phase_17.md](phase_17.md): complete degraded and error paths |
...
- Sub-phase 16.3 is complete; sub-phase 16.4 is ready to open.
...
| 16.4 | Degraded and error paths (rule T-4) | `agent-2:sonnet` | IN PROGRESS |
...
| `UI-SET-*` | Vitest, unit + route | 16.1 – 16.4 | IN PROGRESS |

...
_Last updated: 2026-09-01 — sub-phase 17.2 closed; sub-phase 17.3 is ready._
...
| **Next action:** | Open sub-phase 17.3 in this file, then implement the CI integration described in `phase_18.md`. |

...
| 14 | [phase_15.md](phase_15.md) | Advisor findings | `agent-2:sonnet` | — | IN_PROGRESS — 14.2 open |
...
| 14.2 | The findings list | `agent-2:sonnet` | OPEN |

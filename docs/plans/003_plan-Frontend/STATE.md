...
_Last updated: 2026-08-31 — phase 8 sub-phase 8.4 closed; sub-phase 8.5 open._
...
| **ID** | 8.5 |
| **Status** | `OPEN` |
| **Intent** | Complete the degraded and error paths under rule T-4 |
| **Next action:** | Complete sub-phase **8.5** in [phase_09.md](phase_09.md): complete the degraded and error paths under rule T-4 |
...
Phase 0 sub-phases 0.1–0.6, phase 1 sub-phases 1.1–1.6, phase 2 sub-phases 2.1–2.7, phase 3 sub-phases 3.1–3.6, phase 4 sub-phases 4.1–4.8, phase 5 sub-phases 5.1–5.11, phase 6 sub-phases 6.1–6.8, phase 7 sub-phases 7.1–7.7, and phase 8 sub-phases 8.1–8.4 are closed; sub-phase 8.5 is open.
- Phases 5, 6, and 7 are complete; phase 8 is in progress and its degraded/error-path unit is open.
...
`claimed — nothing written yet for sub-phase 8.5`
...
| 8 | [phase_09.md](phase_09.md) | Fleet Overview | `agent-2:sonnet` | 8.4 | IN_PROGRESS — 8.5 open |
...
| 8.5 | Degraded and error paths (rule T-4) | `agent-2:sonnet` | OPEN |

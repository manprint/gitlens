...
_Last updated: 2026-09-01 — phase 13 sub-phase 13.1 closed; 13.2 open._
...
| **ID** | 13.2 |
| **Status** | `OPEN` |
| **Intent** | Build the sampled blocking tree view |
| **Next action:** | Complete sub-phase **13.2** in [phase_14.md](phase_14.md): render ranked lock roots, sample age, truncation, cycles, and keyboard navigation |
...
| 13 | [phase_14.md](phase_14.md) | Locks and Activity | `agent-2:sonnet` | 13.4 | IN_PROGRESS — 13.2 open |
...
| 13.2 | The blocking tree view | `agent-2:sonnet` | OPEN |

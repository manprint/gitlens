...
_Last updated: 2026-09-01 — phase 13 sub-phase 13.4 closed; 13.5 open._
...
| **ID** | 13.5 |
| **Status** | `OPEN` |
| **Intent** | Cover degraded and error paths for Locks and Activity |
| **Next action:** | Complete sub-phase **13.5** in [phase_14.md](phase_14.md): make stale, degraded, error, and unavailable states explicit |
...
| 13 | [phase_14.md](phase_14.md) | Locks and Activity | `agent-2:sonnet` | 13.5 | IN_PROGRESS — 13.1–13.4 done, 13.5 open |
...
| 13.5 | Degraded and error paths (rule T-4) | `agent-2:sonnet` | OPEN |

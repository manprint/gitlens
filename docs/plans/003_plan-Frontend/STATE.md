...
_Last updated: 2026-09-01 — phase 16 sub-phase 16.1 open (claimed)._
...
| **ID** | 16.1 |
| **Status** | `OPEN` |
| **Intent** | Build the inventory tables |
| **Next action:** | Complete sub-phase **16.1** in [phase_17.md](phase_17.md): build the inventory tables and derived agent view |
...
| 16.1 | Inventory tables | `agent-2:sonnet` | OPEN |
